...
public class CaixaEletronico {
    ...
    public void esvaziarCaixaEletronico(){
        for(CaixaCedula cedula : listaCedulas){
            cedula.setQtdCedula(0);
        }
    }
    ...
    public String getMovimentacaoBanco() {
        String resultado = "";
    ...
    public Movimentacao getMovimentacaoAprovar(){
        for(Movimentacao movimentacao : listaMovimentacao){
            if (!movimentacao.isValidado()) {
                return movimentacao;
            }
        }
        return null;
